...
\firstname{Maxime}
\familyname{Beugnet}
\title{Ingénieur en Informatique: Génie Logiciel\newline\mbox{~~~~~~~~~~~~3 années d'expérience}} % optional, remove the line if not wanted
...
\quote{Développeur passionné de nouvelles technologies.\\Disponible début Avril 2015.}    % optional, remove the line if not wanted
...
\cvline{Node.js}{En cours d'apprentissage.}
\cvline{Frameworks}{Hibernate, Spring, Struts, XStream, Mockito, Junit, AssertJ, Apache Commons.}
\cvline{BDD}{MongoDB, Elastic, PostgreSQL, DB2, PL/SQL.}
\cvline{BigData}{Hadoop.}
\cvline{Autres langages}{C, C\#, Script Shell, HTML, CSS, Javascript.}
\cvline{Systèmes}{GNU/Linux.}
\cvline{Outils}{IntelliJ, Eclipse, Docker, Tomcat, Maven, Git, ClearCase, ClearTool, Subversion, Bazaar, CVS, VSS.}
