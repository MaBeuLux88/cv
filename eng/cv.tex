...
\newline\newline
I am a Java and official MongoDB trainer with various certifications like MongoDB developer (C100DEV), MongoDB DBA (C100DBA) and several Couchbase certifications.
\newline\newline
...
\cvline{Frameworks}{Spring Core, Spring-Boot, Spring-Data, Hibernate, XStream, Mockito, Junit, TestNG, AssertJ, Apache Commons, ...}
\cvline{NoSQL}{MongoDB, Couchbase, Elastic.}
\cvline{SQL}{MySQL, PostgreSQL, PL/SQL.}
\cvline{BigData}{Hadoop.}
\cvline{Languages}{C, C\#, Script Shell, Python, HTML5, CSS3, Javascript.}
