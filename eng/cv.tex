...
\newline\newline
I'm a Java and official MongoDB trainer with various certifications like MongoDB developer (C100DEV) and MongoDB DBA (C100DBA) and I also have several Couchbase certifications.
\newline\newline
I have also been co-leading the MongoDB User Group Paris and Dev4Fun Meetups for the past 2 years. I frequent the Software Craftsmanship Meetup regularly and I have a special interest in BigData as well.}    % optional, remove the line if not wanted

% trying to change the quote width
\usepackage{etoolbox}
